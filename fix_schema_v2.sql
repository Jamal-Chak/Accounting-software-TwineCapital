...
-- 1. Companies table (Root dependency)
...
-- 2. Insert Demo Company (Critical for other tables)
-- We use a specific ID for the demo company to ensure consistency
...
-- 11. Create Policies (Simplified to avoid errors)
-- We use DO blocks to check existence before creating policies
DO $$
BEGIN
    -- Companies policies
...
-- 12. Insert sample expenses (Now safe because company exists)
